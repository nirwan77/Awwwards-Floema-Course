...
export default class {
    ...
    update(){
        ...
        this.x.current = GSAP.utils.interpolate( this.x.current, this.x.target, 0.1 ); // prettier-ignore
        this.y.current = GSAP.utils.interpolate( this.y.current, this.y.target, 0.1 ); // prettier-ignore
